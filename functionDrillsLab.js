...
console.log(bigNum(5,1))
console.log(bigNum(1,5))
...
console.log("cameron:", exclaimThree("cameron"))
...
console.log("Steven:", nameGreeting)
console.log("Bryan:", nameCheck("Bryan"))
console.log("Cameron:", nameCheck("Cameron"))
...
/*
  ...
  Create a variable called 'colorRating' and set it equal to faveColorFinder invoked 
...
console.log("red:", faveColorFinder('red'))
console.log("green:", faveColorFinder('green'))
console.log("black:", faveColorFinder('black'))
console.log("yellow:", faveColorFinder('yellow'))
...
console.log("oddChecker(7):", oddChecker)
console.log("oddChecker(4):", thatsOdd(4))
...
console.log("Sharknado:", bestMovie("Sharknado"))
...
console.log("arrayEvaluator", arrayEvaluator)
...
function printInUppercase(p1){
  console.log(p1.toUpperCase())
}
printInUppercase(sampleString)
...
console.log('emailCheck(" email@email.com":', emailCheck(" email@email.com "))
console.log('emailCheck("abcd":', emailCheck("abcd"))

////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as many 
  chocolate frogs as possible with a certain amount of gold. Each chocolate frog costs 
  3 gold. Your function should take in a single parameter, which is the amount of gold 
  you are willing to spend. Your function should return a total amount of chocolate frogs 
...
let totalFrogs = buyFrogs(22)
console.log("buyFrogs(22):", totalFrogs)
console.log("buyFrogs(21):", buyFrogs(21))



////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. If you were to pass 
  in 4 gold, the function would return to you 1.3333... However, you can't really 
  go to a store and by 1.333 products. You would just be able to purchase 1 product. 
...
let totalFrogs2 = buyFrogs2(22)
console.log("buyFrogs2(22):", totalFrogs2)
...
/*
  Write a function that takes in an array of numbers as an argument. In the body of 
  the function, write logic to determine if the array is in ascending order. The 
  function should return true, if it is sorted in ascending order, false if it is not. 
...
console.log("isAscending(sampleArray)", arrayIsAscending)
console.log("isAscending(sampleArray2)", isAscending(sampleArray2))
...
//This array should contain the variable names (as strings) accessible in the bathroom 
//function.
